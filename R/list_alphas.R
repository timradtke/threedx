...
#' 
#' The parameter combinations generated by [list_edge_alphas()] encode a set of
#' important edge cases between which a `threedx` model can interpolate.
#' 
#' @return A data frame with columns `alpha`, `alpha_seasonal`, and
#'   `alpha_seasonal_decay`, and five rows; all values are between 0 and 1
#'
#' @seealso [list_sampled_alphas()], [learn_weights()]
#' 
#' @export
#'
#' @examples 
...
#'   0 and 1
#' 
#' @seealso [list_edge_alphas()], [learn_weights()]
#' 
#' @export
#' @examples
