...
expect_weights_seasonal_decay_matrix <- function(weights, alphas, n, period_length) {
  expect_matrix(
  ...
  weights_expected <- t(vapply(
    ...
    FUN = function(alpha) {
      weights_seasonal_decay(
        alpha_seasonal_decay = alpha, n = n, period_length = period_length
      )
    },
...
test_that("returns the same weights as `weights_seasonal()`", {
  ...
  period_length <- 3
  weights <- weights_seasonal_decay_vec(
    alphas_seasonal_decay = alphas, n = n, period_length = period_length
  )
  expect_weights_seasonal_decay_matrix(
...
test_that("fails for `period_length < 3`", {
  expect_error(
    weights_seasonal_decay_vec(alphas_seasonal_decay = alphas, n = 50, period_length = 2)
  )
  
  expect_error(
    weights_seasonal_decay_vec(alphas_seasonal_decay = alphas, n = 50, period_length = 1)
  )
  
  expect_error(
    weights_seasonal_decay_vec(alphas_seasonal_decay = alphas, n = 50, period_length = 0)
  )
})
